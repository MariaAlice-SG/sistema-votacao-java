...
public class SistemaVotacao {
    ...
    static void cadastrarCandidatos() {
        ...
        int quantidade;
        do {quantidade = lerInteiro("Quantidade de candidatos entre 1 e 5: ");
    ...
    static void mostrarCandidatos() {
        ...
        for (int i = 0;
            ...
            System.out.println(numerosCandidatos[i]
                            + " - "
                            + nomesCandidatos[i]);
        }
    }
    ...
    static void exibirResultado() {
        ...
        for (int i = 0;
            ...
            System.out.printf("%s -> %d voto(s) (%.2f%%)%n",
                    nomesCandidatos[i],
                    votosCandidatos[i],
                    percentual);
        }
        ...
        System.out.println("Maior quantidade de votos: " + maiorQuantidadeVotos);
